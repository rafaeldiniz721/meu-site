...
<title>Resgatando a Fé — Método Comprovado</title>
<meta name="description" content="E-book prático que ajuda pais a reconectar seus filhos com a fé em 30 dias. Oferta limitada e bônus exclusivos!">
<style>
:root{
  --verde:#2fa66f;
  --azul:#1f6fb8;
  ...
  --cinza:#f5f7f9;
  --texto:#1f2933;
  --card-shadow:0 8px 25px rgba(31,41,51,0.08);
  font-family:Inter,ui-sans-serif,system-ui,-apple-system,'Segoe UI',Roboto,'Helvetica Neue',Arial;
}
*{box-sizing:border-box}
body{margin:0;background:linear-gradient(180deg,var(--branco),var(--cinza));color:var(--texto);-webkit-font-smoothing:antialiased;padding-top:70px;}
.container{max-width:1100px;margin:0 auto;padding:28px;}
#top-timer{
  position:fixed;top:0;left:0;width:100%;background:var(--verde);color:white;text-align:center;padding:16px;font-weight:700;z-index:9999;font-size:16px;
...
header{display:flex;align-items:center;justify-content:space-between;padding:18px 0;flex-wrap:wrap}
.logo{display:flex;gap:12px;align-items:center}
.logo .mark{width:48px;height:48px;border-radius:12px;background:linear-gradient(135deg,var(--verde),var(--azul));display:flex;align-items:center;justify-content:center;color:white;font-weight:700;font-size:18px}
nav a{margin-left:14px;color:var(--texto);text-decoration:none;font-weight:600;transition:0.3s;}
nav a:hover{color:var(--azul)}

/* Hero */
.hero{display:grid;grid-template-columns:1fr 420px;gap:28px;align-items:start;margin-top:12px}
.hero-card{background:var(--branco);padding:28px;border-radius:16px;box-shadow:var(--card-shadow)}
.badge{display:inline-block;padding:6px 10px;border-radius:999px;background:rgba(47,166,111,0.12);color:var(--verde);font-weight:700;font-size:13px}
h1{margin:14px 0 6px;font-size:34px}
p.lead{margin:0 0 16px;color:#425063;font-size:16px;line-height:1.5}
.price{font-size:26px;font-weight:800;color:var(--azul)}
.cta{display:inline-block;margin-top:14px;padding:14px 20px;border-radius:12px;background:linear-gradient(90deg,var(--verde),var(--azul));color:white;text-decoration:none;font-weight:800;transition:0.3s;cursor:pointer}
.cta:hover{opacity:0.9}
.cta.secondary{background:transparent;border:2px solid rgba(31,111,184,0.08);color:var(--azul);font-weight:700;margin-left:8px;transition:0.3s}
.cta.secondary:hover{background:rgba(31,111,184,0.08);}
...
<details><summary>Como meu filho irá reagir?</summary><p>O método é baseado em diálogo e pequenas ações diárias. A adaptação é natural e gradual.</p></details>
<details><summary>O e-book é digital?</summary><p>Sim, você recebe PDF imediatamente após a compra e acesso aos bônus online.</p></details>
<details><summary>Posso aplicar sozinho?</summary><p>Sim! É feito para qualquer pai ou mãe aplicar sem necessidade de experiência.</p></details>
</section>
